...
public class ServidorGeneradorFiltro {

    public static void main(String[] args) throws Exception {
        Scanner teclado = new Scanner(System.in);
        System.out.println("Servidor productor compatible con @generar_valor#@.");
        int puerto = pedirEntero(teclado, "Puerto", 6200);

        try (ServerSocket servidor = new ServerSocket(puerto)) {
            System.out.println("Servidor generador escuchando en " + puerto);
            while (true) {
        ...
        try (socket;
            ...
            while ((linea = entrada.readLine()) != null) {
                if (linea.equals("@generar_valor#@")) {
                    int valor = 100 + random.nextInt(900);
            ...
            System.err.println("Cliente del generador desconectado.");
        }
    }
